...
* @returns {WasmPastaFpPlonkIndex}
*/
  static deserialize(bytes: Uint8Array): WasmPastaFpPlonkIndex;
}
/**
*/
...
* @returns {WasmPastaFqPlonkIndex}
*/
  static deserialize(bytes: Uint8Array): WasmPastaFqPlonkIndex;
}
/**
*/
...
export interface InitOutput {
  ...
  readonly wasmfpgatevector_serialize: (a: number, b: number) => void;
  readonly wasmfpgatevector_deserialize: (a: number, b: number, c: number) => void;
  ...
  readonly wasmfqgatevector_serialize: (a: number, b: number) => void;
  readonly wasmfqgatevector_deserialize: (a: number, b: number, c: number) => void;
  ...
  readonly wasmfpsrs_serialize: (a: number, b: number) => void;
  readonly wasmfpsrs_deserialize: (a: number, b: number, c: number) => void;
  ...
  readonly wasmfqsrs_serialize: (a: number, b: number) => void;
  readonly wasmfqsrs_deserialize: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_wasmvecfq_free: (a: number) => void;
  readonly wasmvecfq_create: (a: number) => number;
  readonly wasmvecfq_push: (a: number, b: number, c: number) => void;
  readonly wasmvecfq_get: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_wasmvecfp_free: (a: number) => void;
  readonly wasmvecfp_create: (a: number) => number;
  readonly wasmvecfp_push: (a: number, b: number, c: number) => void;
  readonly wasmvecfp_get: (a: number, b: number, c: number) => void;
  ...
  readonly wasmpastafpplonkindex_serialize: (a: number, b: number) => void;
  readonly wasmpastafpplonkindex_deserialize: (a: number, b: number, c: number) => void;
  ...
  readonly wasmpastafqplonkindex_serialize: (a: number, b: number) => void;
  readonly wasmpastafqplonkindex_deserialize: (a: number, b: number, c: number) => void;
