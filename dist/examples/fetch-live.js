...
function logNetworkConstants(networkConstants) {
    ...
    console.log(`Genesis date: ${new Date(Number(networkConstants?.genesisTimestamp.toString() ?? '0'))}`);
}
//# sourceMappingURL=fetch-live.js.map