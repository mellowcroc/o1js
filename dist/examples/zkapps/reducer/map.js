...
import { Field, Struct, method, PrivateKey, SmartContract, Mina, AccountUpdate, Reducer, provable, PublicKey, Bool, Poseidon, Provable, assert, } from 'o1js';
/*
...
class StorageContract extends SmartContract {
    ...
    async get(key) {
        ...
        let optionValue = this.reducer.reduce(pendingActions, Option, (state, action) => {
...
__decorate([
    ...
    __metadata("design:paramtypes", [PublicKey, Field]),
    __metadata("design:returntype", Promise)
], StorageContract.prototype, "set", null);
__decorate([
    method.returns(Option),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey]),
    __metadata("design:returntype", Promise)
], StorageContract.prototype, "get", null);
let k = 1 << 4;
