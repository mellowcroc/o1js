...
let deployTx = await Mina.transaction(senderSpec, async () => {
    AccountUpdate.createSigned(sender).balance.subInPlace(Mina.getNetworkConstants().accountCreationFee);
...
if (keyPairReleaseMessage2)
    console.info(keyPairReleaseMessage2);
