...
const admin = Mina.TestPublicKey(PrivateKey.fromBase58('EKEs6QLnX9gpqpto6tiL3TBcd3C4xx8Pyrek9Figake1Vqov1thL'));
class TokenEscrow extends SmartContract {
     ...
     */
    async withdrawOptimized(amount) {
        // only the admin can withdraw
...
], TokenEscrow.prototype, "withdraw", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [UInt64]),
    __metadata("design:returntype", Promise)
], TokenEscrow.prototype, "withdrawOptimized", null);
// local test
...
await tx2.send();
//# sourceMappingURL=token-escrow.js.map