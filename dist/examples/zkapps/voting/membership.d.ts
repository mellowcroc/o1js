...
export declare class Membership_ extends SmartContract {
     ...
     */
    committedMembers: State<import("../../../../dist/node/lib/provable/field.js").Field>;
    /**
     * Accumulator of all emitted members.
     */
    accumulatedMembers: State<import("../../../../dist/node/lib/provable/field.js").Field>;
    reducer: {
    ...
    events: {
        newMemberState: Omit<import("../../../../dist/node/lib/provable/types/provable-intf.js").Provable<{
            accumulatedMembersRoot: import("../../../../dist/node/lib/provable/field.js").Field;
            committedMembersRoot: import("../../../../dist/node/lib/provable/field.js").Field;
        }, {
            accumulatedMembersRoot: bigint;
            committedMembersRoot: bigint;
        }>, "fromFields"> & {
     ...
     * @param member
     */
    addEntry(member: Member): Promise<import("../../../../dist/node/lib/provable/bool.js").Bool>;
    /**
     * Method used to check whether a member exists within the committed storage.
     * @param accountId
     * @returns true if member exists
     */
    isMember(member: Member): Promise<import("../../../../dist/node/lib/provable/bool.js").Bool>;
    /**
