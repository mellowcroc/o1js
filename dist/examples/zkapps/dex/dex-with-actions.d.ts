...
declare class Dex extends TokenContract {
    ...
    events: {
        'supply-liquidity': (new (value: {
            ...
            fromValue: (value: {
                ...
                dx: number | bigint | UInt64;
                dy: number | bigint | UInt64;
            }) => {
                address: PublicKey;
                dx: UInt64;
                dy: UInt64;
    ...
    get typedEvents(): {
        emit<Key extends "supply-liquidity" | "redeem-liquidity">(key: Key, event: import("../../../../dist/node/bindings/lib/provable-generic.js").InferProvable<{
            'supply-liquidity': (new (value: {
                address: PublicKey;
                dx: UInt64;
                dy: UInt64;
        ...
        }[Key], import("../../../../dist/node/lib/provable/field.js").Field>): void;
    };
    /**
...
declare class DexTokenHolder extends SmartContract {
    redeemActionState: State<import("../../../../dist/node/lib/provable/field.js").Field>;
    ...
    get typedEvents(): {
        emit<Key extends "swap">(key: Key, event: import("../../../../dist/node/bindings/lib/provable-generic.js").InferProvable<{
            swap: (new (value: {
                address: PublicKey;
                dx: UInt64;
            }) => {
...
declare let keys: Record<"user" | "tokenX" | "tokenY" | "dex", import("o1js").PrivateKey>, addresses: Record<"user" | "tokenX" | "tokenY" | "dex", PublicKey>;
