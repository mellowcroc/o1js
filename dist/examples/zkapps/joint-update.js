...
], A.prototype, "updateWithB", null);
class B extends SmartContract {
    constructor() {
        super(...arguments);
        this.twoToN = State(Field(1));
        // boolean flag which is only active during `updateWithA()`
        this.insideBUpdate = State(Bool(false));
    }
    async updateWithA() {
...
__decorate([
    state(Field),
    __metadata("design:type", Object)
], B.prototype, "twoToN", void 0);
__decorate([
    state(Bool),
    __metadata("design:type", Object)
], B.prototype, "insideBUpdate", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], B.prototype, "updateWithA", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], B.prototype, "assertInsideUpdate", null);
//# sourceMappingURL=joint-update.js.map