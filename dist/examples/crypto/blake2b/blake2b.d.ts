...
declare let BLAKE2BProgram: {
    ...
    analyzeMethods: () => Promise<{
        blake2b: import("../../../../dist/node/lib/provable/core/provable-context.js").ConstraintSystemSummary & {
            proofs: import("../../../../dist/node/lib/proof-system/proof.js").ProofClass[];
        };
    }>;
    analyzeSingleMethod<K extends "blake2b">(methodName: K): Promise<import("../../../../dist/node/lib/provable/core/provable-context.js").ConstraintSystemSummary & {
        proofs: import("../../../../dist/node/lib/proof-system/proof.js").ProofClass[];
    }>;
    ...
    privateInputTypes: {
        blake2b: [typeof Bytes12];
    };
    auxiliaryOutputTypes: {
        blake2b: undefined;
    };
    rawMethods: {
        blake2b: (args_0: import("../../../../dist/node/lib/provable/bytes.js").Bytes) => Promise<{
    ...
    blake2b: (args_0: import("../../../../dist/node/lib/provable/bytes.js").Bytes | {
        bytes: {
            value: bigint;
        }[];
    }) => Promise<{
