import { DynamicProof, Field, Undefined, VerificationKey, ZkProgram, verify } from 'o1js';
 ...
 */
class DynamicMultiplyProof extends DynamicProof {
}
DynamicMultiplyProof.publicInputType = Undefined;
DynamicMultiplyProof.publicOutputType = Field;
DynamicMultiplyProof.maxProofsVerified = 1;
const add = ZkProgram({
    name: 'add',
...
const { proof: add2 } = await add.performAddition(Field(4), DynamicMultiplyProof.fromProof(multiply1), multiplyVk);
...
//# sourceMappingURL=mutual-recursion.js.map