import { Bool, Experimental, Int64, PrivateKey, sendZkapp, UInt32, UInt64 } from 'o1js';
const { ZkappCommand, ZkappFeePayment, AccountUpdate, AccountUpdateAuthorizationKind, GenericData, AccountId, TokenId, } = Experimental.V2;
...
let response = await sendZkapp(JSON.stringify(paymentCommand.toJSON()), 'https://api.minascan.io/node/devnet/v1/graphql');
