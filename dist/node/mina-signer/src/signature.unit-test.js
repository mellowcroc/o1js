...
function checkConsistentSingle(msg, key, keySnarky, pk, networkId) {
    ...
    expect(verifyFieldElement(sig, msg, pk, networkId === 'mainnet' ? 'testnet' : 'mainnet')).toEqual(false);
    expect(verifyFieldElement(sig, msg, pk, networkId === 'mainnet' ? 'devnet' : 'mainnet')).toEqual(false);
...
let privateKeys = [
    ...
    28948022309329048855892746252171976963363056481941560715954676764349967630337n, // the keys below this line (including) are larger than p smaller than q
    28948022309329048855892746252171976963363056481941570345257461873688122665643n, // where p is the modulus of the base field 
    28948022309329048855892746252171976963363056481941579974560246983026277700950n, // and q is the modulus of the scalar field
    28948022309329048855892746252171976963363056481941589603863032092364432736257n,
    28948022309329048855892746252171976963363056481941599233165817201702587771563n,
    28948022309329048855892746252171976963363056481941608862468602311040742806870n,
    28948022309329048855892746252171976963363056481941618491771387420378897842177n,
    28948022309329048855892746252171976963363056481941628121074172529717052877483n,
    28948022309329048855892746252171976963363056481941637750376957639055207912790n,
