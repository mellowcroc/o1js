 ...
 */
import { Bigint256Bindings, fromMlString, mlBytesFromUint8Array, mlBytesToUint8Array, toMlStringAscii, } from './bigint256.js';
import { wasm } from '../../js/node/node-backend.js';
import { defaultAssertEqual, id } from '../../../lib/testing/equivalent.js';
import { Random } from '../../../lib/testing/property.js';
import { affineFromRust, affineToRust, fieldFromRust, fieldToRust, } from './conversion-base.js';
import { equivalentRecord } from './test-utils.js';
import { MlBool, MlOption } from '../../../lib/ml/base.js';
import { PallasBindings, VestaBindings, toMlOrInfinity } from './curve.js';
import { Pallas, Vesta } from '../elliptic-curve.js';
import { Fp, Fq } from '../finite-field.js';
let number = { back: id };
let numberLessThan = (max) => ({
...
// elliptic curve
let pallas = projective(Pallas, Fq, wasm.caml_pallas_affine_one, wasm.caml_pallas_of_affine, wasm.caml_pallas_to_affine);
let pallasAffine = affine(Pallas, Fq, wasm.caml_pallas_affine_one);
let vesta = projective(Vesta, Fp, wasm.caml_vesta_affine_one, wasm.caml_vesta_of_affine, wasm.caml_vesta_to_affine);
let vestaAffine = affine(Vesta, Fp, wasm.caml_vesta_affine_one);
...
function projective(Curve, Scalar, affineOne, projOfAffine, projToAffine) {
...
function affine(Curve, Scalar, affineOne) {
    let randomScaled = Random(() => Curve.scale(Curve.one, Scalar.random()));
    ...
    return {
        rng,
        there: (p) => affineToRust(p, affineOne),
        back: affineFromRust,
    };
}
//# sourceMappingURL=bindings.unit-test.js.map