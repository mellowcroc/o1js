...
class WasmPastaFqRuntimeTableCfg {
    ...
    */
    constructor(id, first_column) {
        const ptr0 = passArray8ToWasm0(first_column, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpastafqruntimetablecfg_new(id, ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        return this;
    }
}
...
module.exports.__wbg_log_d6533901783bf880 = function(arg0, arg1) {
...
module.exports.__wbg_startWorkers_bca1c328ac5b8aa1 = function(arg0, arg1, arg2) {
    const ret = startWorkers(takeObject(arg0), takeObject(arg1), PoolBuilder.__wrap(arg2));
    return addHeapObject(ret);
};

module.exports.__wbg_terminateWorkers_34b0d425a6d1111c = function() {
...
const path = require('path').join(__dirname, 'kimchi_wasm_bg.wasm');
