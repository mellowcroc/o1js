...
function getMemory() {
    return {
        wasm: wasm.__wasm.memory.buffer.byteLength / (1024 * 1024),
...
export async function testLazyMode(lazyMode) {
...
function runSubprocess(lazyMode) {
...
//# sourceMappingURL=lazy-mode.unit-test.js.map