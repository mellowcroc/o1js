...
import { Actions as V1Actions, Events as V1Events, Sign as V1Sign, TokenSymbol as V1TokenSymbol, ZkappUri as V1ZkappUri, } from '../../../bindings/mina-transaction/v1/transaction-leaves.js';
...
import { testV1V2ClassEquivalence, testV1V2ValueEquivalence, testV2Encoding, } from './test/utils.js';
...
function testHashEquality(v1, v2) {
...
const V1AccountUpdate = TypesV1.provableFromLayout(layoutV1.AccountUpdate /* WOOPS */);
const v1AccountUpdate = {
    authorization: {
        proof: 'proof',
        signature: 'signature',
    },
...
const v2AccountUpdate = new Authorized({
    proof: 'proof',
    signature: 'signature',
    ...
    preconditions: {
        ...
        account: {
            ...
            delegate: publicKey,
            state: new GenericStatePreconditions(new Array(ZkappConstants.MAX_ZKAPP_STATE_FIELDS).fill(Precondition.Equals.equals(new Field(444444)))),
    ...
    pushEvents: events,
    pushActions: actions,
    setState: new GenericStateUpdates(new Array(ZkappConstants.MAX_ZKAPP_STATE_FIELDS).fill(Update.set(new Field(ZkappConstants.MAX_ZKAPP_STATE_FIELDS)))),
...
// encoding tests
{
    ...
    testV2Encoding(Authorized, v2AccountUpdate);
    testV1V2ClassEquivalence(V1AccountUpdate, Authorized, 0);
    testHashEquality(V1AccountUpdate.empty(), Authorized.empty());
    testV1V2ValueEquivalence(V1AccountUpdate, Authorized, v1AccountUpdate, v2AccountUpdate, 2);
    testHashEquality(v1AccountUpdate, v2AccountUpdate);
}
// signature test
{
    let v1Hash = hashWithPrefix(zkAppBodyPrefix('testnet'), packToFields(Types.AccountUpdate.toInput(v1AccountUpdate)));
