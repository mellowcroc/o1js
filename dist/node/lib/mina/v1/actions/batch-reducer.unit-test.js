 ...
 */
import { AccountUpdate, Bool, Experimental, Field, IndexedMerkleMap, method, Poseidon, Provable, PublicKey, SmartContract, State, state, UInt64, assert, } from '../../../../index.js';
import { expectBalance, testLocal, transaction } from '../test/test-contract.js';
const { BatchReducer } = Experimental;
const MINA = 1000000000n;
...
class UnsafeAirdrop extends SmartContract {
    constructor() {
        ...
        this.actionState = State(BatchReducer.initialActionState);
        this.actionStack = State(BatchReducer.initialActionStack);
        // Merkle map related
        this.eligibleRoot = State(eligible.root);
        this.eligibleLength = State(eligible.length);
    }
    /**
     * Claim an airdrop.
     */
     ...
     */
    async settleClaims(batch, proof) {
...
], UnsafeAirdrop.prototype, "actionState", void 0);
__decorate([
    state(Field),
    __metadata("design:type", Object)
], UnsafeAirdrop.prototype, "actionStack", void 0);
__decorate([
    state(Field),
    __metadata("design:type", Object)
], UnsafeAirdrop.prototype, "eligibleRoot", void 0);
__decorate([
    state(Field),
    __metadata("design:type", Object)
], UnsafeAirdrop.prototype, "eligibleLength", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], UnsafeAirdrop.prototype, "claim", null);
__decorate([
    method.returns(MerkleMap),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Batch, BatchProof]),
    __metadata("design:returntype", Promise)
], UnsafeAirdrop.prototype, "settleClaims", null);
/**
...
await testLocal(UnsafeAirdrop, { proofsEnabled: 'both', batchReducer }, ({ contract, accounts: { sender }, newAccounts: { alice, bob, charlie, danny, eve }, Local, }) => {
    ...
    return [
        ...
        () => Local.setProofsEnabled(false),
        ...Array.from({ length: 9 }, () => transaction.from(danny)('danny claims 9x', () => contract.claim())),
        () => Local.resetProofsEnabled(),
        // settle claims, 2
        async () => {
...
//# sourceMappingURL=batch-reducer.unit-test.js.map