...
import { method, Mina, UInt64, AccountUpdate, AccountUpdateForest, TokenContract, Int64, PrivateKey, } from '../../../../index.js';
...
], ExampleTokenContract.prototype, "approveBase", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ExampleTokenContract.prototype, "init", null);
// TESTS
...
assert(Mina.getAccount(tokenAddress).zkapp?.verificationKey !== undefined, 'token contract deployed');
...
await assert.rejects(() => Mina.transaction(sender, () => token.approveBase(forest)), /Field\.assertEquals\(\): 1 != 0/);
...
//# sourceMappingURL=token-contract.unit-test.js.map