...
], MyContract.prototype, "shouldMakeCompileThrow", null);
let contractAccount;
let contract;
let feePayer;
describe('transactions', () => {
    ...
    it('fromJSON should serialize and deserialize transaction correctly', async () => {
        ...
        expect(deserializedTx.transaction.feePayer.body.publicKey.x).toEqual(originalTx.transaction.feePayer.body.publicKey.x);
        expect(deserializedTx.transaction.feePayer.body.nonce).toEqual(originalTx.transaction.feePayer.body.nonce);
        expect(deserializedTx.transaction.accountUpdates.length).toEqual(originalTx.transaction.accountUpdates.length);
