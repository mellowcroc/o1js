...
import { AccountUpdate, PublicKey, UInt32, UInt64, signableFromLayout, } from '../../bindings/mina-transaction/gen/v1/transaction-bigint.js';
...
test.custom({ negative: true, timeBudget: 1000 })(Random.json.accountUpdate.invalid, AccountUpdate.fromJSON);
const FeePayer = signableFromLayout(jsLayout.ZkappCommand.entries.feePayer);
test.negative(Random.json.feePayer.invalid, FeePayer.fromJSON);
//# sourceMappingURL=testing.unit-test.js.map