...
delete FieldWithoutEmpty.empty;
expect(() => provable({ value: FieldWithoutEmpty }).empty()).toThrow('Expected `empty()` method on anonymous type object');
// check
...
], MyContract.prototype, "x", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [MyStruct,
        MyTuple,
        AccountUpdate,
        Unconstrained]),
    __metadata("design:returntype", Promise)
], MyContract.prototype, "myMethod", null);
...
let tx = await transaction(async () => {
    ...
    }, [address, targetString], accountUpdate, Unconstrained.from(targetBigint));
});
...
//# sourceMappingURL=struct.unit-test.js.map