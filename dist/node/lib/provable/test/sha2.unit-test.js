...
// SHA2-224 TESTS
{
    sample(Random.nat(400), 5).forEach((preimageLength) => {
        ...
        equivalentProvable({ from: [inputBytes], to: outputBytes, verbose: true })((x) => nobleSha224(x), (x) => Gadgets.SHA2.hash(224, x), `sha224 preimage length ${preimageLength}`);
    });
...
// SHA2-256 TESTS
{
    sample(Random.nat(400), 5).forEach((preimageLength) => {
        ...
        equivalentProvable({ from: [inputBytes], to: outputBytes, verbose: true })((x) => nobleSha256(x), (x) => Gadgets.SHA2.hash(256, x), `sha256 preimage length ${preimageLength}`);
    });
...
// SHA2-384 TESTS
{
    sample(Random.nat(400), 5).forEach((preimageLength) => {
        ...
        equivalentProvable({ from: [inputBytes], to: outputBytes, verbose: true })((x) => nobleSha384(x), (x) => Gadgets.SHA2.hash(384, x), `sha384 preimage length ${preimageLength}`);
    });
...
// SHA2-512 TESTS
{
    sample(Random.nat(400), 5).forEach((preimageLength) => {
        ...
        equivalentProvable({ from: [inputBytes], to: outputBytes, verbose: true })((x) => nobleSha512(x), (x) => Gadgets.SHA2.hash(512, x), `sha512 preimage length ${preimageLength}`);
    });
...
//# sourceMappingURL=sha2.unit-test.js.map