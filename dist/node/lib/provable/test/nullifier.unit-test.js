...
let message = Array(5).fill(Field.random());
let jsonNullifier1 = createNullifier(message.map((f) => f.toBigInt()), sk);
...
let jsonNullifier2 = createNullifier(message.map((f) => f.toBigInt()), sk_faulty);
...
//# sourceMappingURL=nullifier.unit-test.js.map