...
describe('BigInt17', () => {
    ...
    describe('Inverse', () => {
        ...
        it('should correctly compute the modular inverse of a random number', () => {
            const a = BigInt17.fromBigInt(1234567890123456789012345678901234567890n % modulus);
            const result = a.inverse();
            const expected = (BigInt(1234567890123456789012345678901234567890n) % modulus) ** (modulus - 2n) % modulus;
        ...
        it('should correctly compute the modular inverse of a number much larger than the modulus', () => {
            ...
            const result = a.inverse();
            const expected = (BigInt(987654321098765432109876543210987654320n) % modulus) ** (modulus - 2n) % modulus;
            expect(result.toBigInt()).toStrictEqual(expected);
        });
    ...
    describe('Power', () => {
        it('should correctly compute the power of a ProvableBigInt with exponent 0', () => {
            ...
            expect(result.toBigInt()).toStrictEqual(BigInt(modularExponentiation(base.toBigInt(), exponent.toBigInt(), modulus))); // 5^0 ≡ 1 (mod 17)
        });
        it('should correctly compute the power of a ProvableBigInt with exponent 1', () => {
            const base = BigInt17.fromBigInt(5n);
            const exponent = BigInt17.fromBigInt(1n);
            const result = base.pow(exponent);
            expect(result.toBigInt()).toStrictEqual(BigInt(modularExponentiation(base.toBigInt(), exponent.toBigInt(), modulus))); // 5^1 ≡ 5 (mod 17)
        });
        it('should correctly compute the power of a ProvableBigInt with a small exponent', () => {
            ...
            const result = base.pow(exponent);
            expect(result.toBigInt()).toStrictEqual(BigInt(modularExponentiation(base.toBigInt(), exponent.toBigInt(), modulus))); // 12^2 ≡ 144 ≡ 8 (mod 17)
        });
        it('should correctly compute the power of a ProvableBigInt with a large exponent', () => {
            ...
            const result = base.pow(exponent);
            expect(result.toBigInt()).toStrictEqual(BigInt(modularExponentiation(base.toBigInt(), exponent.toBigInt(), modulus))); // 3^16 % 17
        });
        it('should correctly compute the power of a ProvableBigInt with a large base and exponent', () => {
            ...
            const exponent = BigInt17.fromBigInt(16n);
            const result = base.pow(exponent);
            expect(result.toBigInt()).toStrictEqual(BigInt(modularExponentiation(base.toBigInt(), exponent.toBigInt(), modulus))); // 16^16 % 17
        });
...
describe('BigInt512', () => {
    const modulus = 0xaadd9db8dbe9c48b3fd4e6ae33c9fc07cb308db3b3c9d20ed6639cca703308717d4d9b009bc66842aecda12ae6a380e62881ff2f2d82c68528aa6056583a48f3n;
