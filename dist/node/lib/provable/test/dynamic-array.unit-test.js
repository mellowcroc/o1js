...
// Out-of-circuit checks of dynamic arrays
{
    ...
    let fromArrayLength = new Bytestring([new UInt8(1), new UInt8(2), new UInt8(3), new UInt8(0)], new Field(3));
...
//# sourceMappingURL=dynamic-array.unit-test.js.map