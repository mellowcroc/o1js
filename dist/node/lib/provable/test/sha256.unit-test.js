...
sample(Random.nat(400), 5).forEach((preimageLength) => {
    ...
    equivalentProvable({ from: [inputBytes], to: outputBytes, verbose: true })((x) => nobleSha256(x), (x) => Gadgets.SHA256.hash(x), `sha256 preimage length ${preimageLength}`);
});
...
function testVectors() {
    return [
        ...
        {
            preimage: 'de188941a3375d3a8a061e67576e926dc71a7fa3f0cceb97452b4d3227965f9ea8cc75076d9fb9c5417aa5cb30fc22198b34982dbb629e',
            hash: '70b6ee0dd06c26d51177d5bb1de954d6d50aa9f7b771b4401415d43da40605ad',
        },
    ];
}
//# sourceMappingURL=sha256.unit-test.js.map