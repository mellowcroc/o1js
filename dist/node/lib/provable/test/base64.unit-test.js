...
function calculateB64DecodedBytesLength(base64String) {
...
function generateRandomString(maxLength, encoding) {
...
describe('Base64 Decode Tests', () => {
    function testBase64Decode(base64String) {
    ...
    test('should reject input containing non-base64 characters', async () => {
        const input = 'ad$=';
        const errorMessage = 'Please provide Base64-encoded bytes containing only alphanumeric characters and +/=';
        expect(() => testBase64Decode(input)).toThrowError(errorMessage);
    });
});
describe('Base64 Encode Tests', () => {
    function testBase64Encode(input) {
...
//# sourceMappingURL=base64.unit-test.js.map