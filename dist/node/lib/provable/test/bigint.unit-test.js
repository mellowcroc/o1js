...
import { equivalentProvable as equivalent, spec, throwError, unit, } from '../../testing/equivalent.js';
...
equivalent({ from: [fq], to: u255 })((x) => Fq.add(x, x), (x) => x.double());
...
equivalent({ from: [fq, fq], to: fq })((x, y) => Fq.div(x, y) ?? throwError('division by 0'), (x, y) => x.div(y));
equivalent({ from: [fq], to: fq })((x) => Fq.inverse(x) ?? throwError('division by 0'), (x) => x.inverse());
equivalent({ from: [fq], to: u255 })(Fq.negate, (x) => x.negate());
equivalent({ from: [fq, fq], to: u255 })(Fq.power, (x, y) => x.pow(y));
equivalent({ from: [fq], to: u255 })((x) => Fq.sqrt(x) ?? throwError(), (x) => x.sqrt());
// comparison
equivalent({ from: [fq, fq], to: unit })((x, y) => x === y || throwError('not equal'), (x, y) => x.assertEquals(y));
...
equivalent({ from: [blsp], to: u381 })((x) => bls_Fp.add(x, x), (x) => x.double());
...
equivalent({ from: [blsp, blsp], to: blsp })((x, y) => bls_Fp.div(x, y) ?? throwError('division by 0'), (x, y) => x.div(y));
equivalent({ from: [blsp], to: blsp })((x) => bls_Fp.inv(x) ?? throwError('division by 0'), (x) => x.inverse());
equivalent({ from: [blsp], to: u381 })(bls_Fp.neg, (x) => x.negate());
equivalent({ from: [blsp, blsp], to: u381 })(bls_Fp.pow, (x, y) => x.pow(y));
equivalent({ from: [blsp], to: u381 })((x) => bls_Fp.sqrt(x) ?? throwError(), (x) => x.sqrt());
// comparison
equivalent({ from: [blsp, blsp], to: unit })((x, y) => x === y || throwError('not equal'), (x, y) => x.assertEquals(y));
...
equivalent({ from: [sfp], to: u521 })((x) => secp521r1_Fp.add(x, x), (x) => x.double());
...
equivalent({ from: [sfp, sfp], to: sfp })((x, y) => secp521r1_Fp.div(x, y) ?? throwError('division by 0'), (x, y) => x.div(y));
equivalent({ from: [sfp], to: sfp })((x) => secp521r1_Fp.inv(x) ?? throwError('division by 0'), (x) => x.inverse());
equivalent({ from: [sfp], to: u521 })(secp521r1_Fp.neg, (x) => x.negate());
equivalent({ from: [sfp, sfp], to: u521 })(secp521r1_Fp.pow, (x, y) => x.pow(y));
equivalent({ from: [sfp], to: u521 })((x) => secp521r1_Fp.sqrt(x) ?? throwError(), (x) => x.sqrt());
// comparison
equivalent({ from: [sfp, sfp], to: unit })((x, y) => x === y || throwError('not equal'), (x, y) => x.assertEquals(y));
