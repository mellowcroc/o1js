...
describe('Circuit String', () => {
    describe('#equals', () => {
        test('returns true when values are equal', async () => {
            const str = CircuitString.fromString('Everything we hear is an opinion, not a fact. Everything we see is a perspective, not the truth');
            const same_str = CircuitString.fromString('Everything we hear is an opinion, not a fact. Everything we see is a perspective, not the truth');
    ...
    describe('#toString', () => {
        test('serializes to string', async () => {
            const js_str = 'Everything we hear is an opinion, not a fact. Everything we see is a perspective, not the truth';
