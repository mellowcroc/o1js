...
export function get_memory(): number;
...
export function wasmfpgatevector_serialize(a: number, b: number): void;
export function wasmfpgatevector_deserialize(a: number, b: number, c: number): void;
...
export function wasmfqgatevector_serialize(a: number, b: number): void;
export function wasmfqgatevector_deserialize(a: number, b: number, c: number): void;
...
export function wasmfpsrs_serialize(a: number, b: number): void;
export function wasmfpsrs_deserialize(a: number, b: number, c: number): void;
...
export function wasmfqsrs_serialize(a: number, b: number): void;
export function wasmfqsrs_deserialize(a: number, b: number, c: number): void;
...
export function __wbg_wasmvecfq_free(a: number): void;
export function wasmvecfq_create(a: number): number;
export function wasmvecfq_push(a: number, b: number, c: number): void;
export function wasmvecfq_get(a: number, b: number, c: number): void;
export function wasmvecfq_set(a: number, b: number, c: number, d: number): void;
...
export function __wbg_wasmvecfp_free(a: number): void;
export function wasmvecfp_create(a: number): number;
export function wasmvecfp_push(a: number, b: number, c: number): void;
export function wasmvecfp_get(a: number, b: number, c: number): void;
export function wasmvecfp_set(a: number, b: number, c: number, d: number): void;
...
export function wasmpastafpplonkindex_serialize(a: number, b: number): void;
export function wasmpastafpplonkindex_deserialize(a: number, b: number, c: number): void;
...
export function caml_pasta_fp_plonk_index_create(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number): void;
...
export function wasmpastafqplonkindex_serialize(a: number, b: number): void;
export function wasmpastafqplonkindex_deserialize(a: number, b: number, c: number): void;
export function caml_pasta_fq_plonk_index_create(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number): void;
...
export function wasmgpallas_wasm_clone(a: number): number;
...
export function wasmgvesta_wasm_clone(a: number): number;
