...
export interface InitOutput {
  readonly __wbg_wasmvecfp_free: (a: number, b: number) => void;
  ...
  readonly caml_vesta_endo_base: () => [number, number];
  readonly caml_vesta_endo_scalar: () => [number, number];
  ...
  readonly wasmvecfp_create: (a: number) => number;
  readonly wasmvecfp_get: (a: number, b: number) => [number, number];
  readonly wasmvecfp_push: (a: number, b: number, c: number) => void;
  readonly wasmvecfp_set: (a: number, b: number, c: number, d: number) => void;
  readonly wasmvecvecfp_create: (a: number) => number;
  readonly wasmvecvecfp_get: (a: number, b: number) => [number, number];
  ...
  readonly caml_pallas_endo_base: () => [number, number];
  readonly caml_pallas_endo_scalar: () => [number, number];
  ...
  readonly __wbg_get_wasmfporacles_digest_before_evaluations: (a: number) => [number, number];
  readonly __wbg_get_wasmfporacles_o: (a: number) => number;
  readonly __wbg_get_wasmfporacles_p_eval0: (a: number) => [number, number];
  readonly __wbg_get_wasmfporacles_p_eval1: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_alpha: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_alpha_chal: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_beta: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_gamma: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_joint_combiner: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_joint_combiner_chal: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_u: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_u_chal: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_v: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_v_chal: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_zeta: (a: number) => [number, number];
  readonly __wbg_get_wasmfprandomoracles_zeta_chal: (a: number) => [number, number];
  ...
  readonly fp_oracles_create: (a: number, b: number, c: number, d: number) => [number, number, number];
  ...
  readonly wasmfporacles_opening_prechallenges: (a: number) => [number, number];
  ...
  readonly __wbg_wasmvecfq_free: (a: number, b: number) => void;
  readonly __wbg_wasmvecvecfq_free: (a: number, b: number) => void;
  readonly wasmvecfq_create: (a: number) => number;
  readonly wasmvecfq_get: (a: number, b: number) => [number, number];
  readonly wasmvecfq_push: (a: number, b: number, c: number) => void;
  readonly wasmvecfq_set: (a: number, b: number, c: number, d: number) => void;
  readonly wasmvecvecfq_create: (a: number) => number;
  readonly wasmvecvecfq_get: (a: number, b: number) => [number, number];
  ...
  readonly __wbg_get_wasmfqopeningproof_z1: (a: number) => [number, number];
  readonly __wbg_get_wasmfqopeningproof_z2: (a: number) => [number, number];
  readonly __wbg_get_wasmfqproverproof_ft_eval1: (a: number) => [number, number];
  ...
  readonly caml_pasta_fp_poseidon_block_cipher: (a: number, b: number) => [number, number];
  readonly caml_pasta_fq_plonk_index_create: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
  readonly caml_pasta_fq_plonk_index_decode: (a: number, b: number, c: number) => [number, number, number];
  ...
  readonly caml_pasta_fq_plonk_index_encode: (a: number) => [number, number, number, number];
  ...
  readonly caml_pasta_fq_plonk_index_read: (a: number, b: number, c: number, d: number) => [number, number, number];
  readonly caml_pasta_fq_plonk_index_serialize: (a: number) => [number, number];
  readonly caml_pasta_fq_plonk_index_write: (a: number, b: number, c: number, d: number) => [number, number];
  readonly caml_pasta_fq_plonk_proof_batch_verify: (a: number, b: number, c: number, d: number) => number;
  readonly caml_pasta_fq_plonk_proof_create: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
  ...
  readonly caml_pasta_fq_poseidon_block_cipher: (a: number, b: number) => [number, number];
  ...
  readonly wasmfqlookupcommitments_sorted: (a: number) => [number, number];
  readonly wasmfqopeningproof_delta: (a: number) => number;
  readonly wasmfqopeningproof_lr_0: (a: number) => [number, number];
  readonly wasmfqopeningproof_lr_1: (a: number) => [number, number];
  ...
  readonly wasmfqprovercommitments_w_comm: (a: number) => [number, number];
  ...
  readonly wasmfqproverproof_evals: (a: number) => any;
  readonly wasmfqproverproof_new: (a: number, b: number, c: any, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
  readonly wasmfqproverproof_prev_challenges_comms: (a: number) => [number, number];
  readonly wasmfqproverproof_prev_challenges_scalars: (a: number) => number;
  readonly wasmfqproverproof_proof: (a: number) => number;
  readonly wasmfqproverproof_public_: (a: number) => [number, number];
  readonly wasmfqproverproof_serialize: (a: number) => [number, number];
  readonly wasmfqproverproof_set_commitments: (a: number, b: number) => void;
  readonly wasmfqproverproof_set_evals: (a: number, b: any) => void;
  ...
  readonly __wbg_get_wasmfpdomain_group_gen: (a: number) => [number, number];
  ...
  readonly __wbg_get_wasmfpopeningproof_z2: (a: number) => [number, number];
  ...
  readonly __wbg_get_wasmfpproverproof_ft_eval1: (a: number) => [number, number];
  readonly __wbg_get_wasmfpshifts_s2: (a: number) => [number, number];
  readonly __wbg_get_wasmfpshifts_s3: (a: number) => [number, number];
  readonly __wbg_get_wasmfpshifts_s4: (a: number) => [number, number];
  readonly __wbg_get_wasmfpshifts_s5: (a: number) => [number, number];
  readonly __wbg_get_wasmfpshifts_s6: (a: number) => [number, number];
  readonly __wbg_get_wasmfqdomain_group_gen: (a: number) => [number, number];
  readonly __wbg_get_wasmfqoracles_digest_before_evaluations: (a: number) => [number, number];
  readonly __wbg_get_wasmfqoracles_o: (a: number) => number;
  readonly __wbg_get_wasmfqoracles_p_eval0: (a: number) => [number, number];
  readonly __wbg_get_wasmfqoracles_p_eval1: (a: number) => [number, number];
  readonly __wbg_get_wasmfqpolycomm_shifted: (a: number) => number;
  readonly __wbg_get_wasmfqrandomoracles_alpha: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_alpha_chal: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_beta: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_gamma: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_joint_combiner: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_joint_combiner_chal: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_u: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_u_chal: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_v: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_v_chal: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_zeta: (a: number) => [number, number];
  readonly __wbg_get_wasmfqrandomoracles_zeta_chal: (a: number) => [number, number];
  readonly __wbg_get_wasmfqshifts_s1: (a: number) => [number, number];
  readonly __wbg_get_wasmfqshifts_s2: (a: number) => [number, number];
  readonly __wbg_get_wasmfqshifts_s3: (a: number) => [number, number];
  readonly __wbg_get_wasmfqshifts_s4: (a: number) => [number, number];
  readonly __wbg_get_wasmfqshifts_s5: (a: number) => [number, number];
  readonly __wbg_get_wasmfqshifts_s6: (a: number) => [number, number];
  ...
  readonly caml_fp_srs_b_poly_commitment: (a: number, b: number, c: number) => [number, number, number];
  readonly caml_fp_srs_batch_accumulator_check: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly caml_fp_srs_batch_accumulator_generate: (a: number, b: number, c: number, d: number) => [number, number];
  readonly caml_fp_srs_commit_evaluations: (a: number, b: number, c: number, d: number) => [number, number, number];
  readonly caml_fp_srs_create: (a: number) => number;
  readonly caml_fp_srs_create_parallel: (a: number) => number;
  readonly caml_fp_srs_get: (a: number) => [number, number];
  readonly caml_fp_srs_get_lagrange_basis: (a: number, b: number) => [number, number];
  readonly caml_fp_srs_h: (a: number) => number;
  readonly caml_fp_srs_lagrange_commitment: (a: number, b: number, c: number) => [number, number, number];
  readonly caml_fp_srs_lagrange_commitments_whole_domain_ptr: (a: number, b: number) => number;
  readonly caml_fp_srs_lagrange_commitments_whole_domain_read_from_ptr: (a: number) => [number, number];
  readonly caml_fp_srs_maybe_lagrange_commitment: (a: number, b: number, c: number) => number;
  readonly caml_fp_srs_read: (a: number, b: number, c: number) => [number, number, number];
  ...
  readonly caml_fp_srs_write: (a: number, b: number, c: number, d: number) => [number, number];
  readonly caml_fq_srs_add_lagrange_basis: (a: number, b: number) => void;
  readonly caml_fq_srs_b_poly_commitment: (a: number, b: number, c: number) => [number, number, number];
  readonly caml_fq_srs_batch_accumulator_check: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly caml_fq_srs_batch_accumulator_generate: (a: number, b: number, c: number, d: number) => [number, number];
  readonly caml_fq_srs_commit_evaluations: (a: number, b: number, c: number, d: number) => [number, number, number];
  readonly caml_fq_srs_create: (a: number) => number;
  readonly caml_fq_srs_create_parallel: (a: number) => number;
  readonly caml_fq_srs_get: (a: number) => [number, number];
  readonly caml_fq_srs_get_lagrange_basis: (a: number, b: number) => [number, number];
  readonly caml_fq_srs_h: (a: number) => number;
  readonly caml_fq_srs_lagrange_commitment: (a: number, b: number, c: number) => [number, number, number];
  readonly caml_fq_srs_lagrange_commitments_whole_domain_ptr: (a: number, b: number) => number;
  readonly caml_fq_srs_lagrange_commitments_whole_domain_read_from_ptr: (a: number) => [number, number];
  ...
  readonly caml_fq_srs_write: (a: number, b: number, c: number, d: number) => [number, number];
  readonly caml_pasta_fp_plonk_circuit_serialize: (a: number, b: number) => [number, number];
  ...
  readonly caml_pasta_fp_plonk_gate_vector_digest: (a: number, b: number) => [number, number];
  ...
  readonly caml_pasta_fp_plonk_index_create: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
  readonly caml_pasta_fp_plonk_index_decode: (a: number, b: number, c: number) => [number, number, number];
  ...
  readonly caml_pasta_fp_plonk_index_encode: (a: number) => [number, number, number, number];
  ...
  readonly caml_pasta_fp_plonk_index_read: (a: number, b: number, c: number, d: number) => [number, number, number];
  readonly caml_pasta_fp_plonk_index_serialize: (a: number) => [number, number];
  readonly caml_pasta_fp_plonk_index_write: (a: number, b: number, c: number, d: number) => [number, number];
  readonly caml_pasta_fp_plonk_proof_batch_verify: (a: number, b: number, c: number, d: number) => number;
  readonly caml_pasta_fp_plonk_proof_create: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
  ...
  readonly caml_pasta_fp_plonk_verifier_index_deserialize: (a: number, b: number, c: number) => [number, number, number];
  readonly caml_pasta_fp_plonk_verifier_index_dummy: () => number;
  readonly caml_pasta_fp_plonk_verifier_index_read: (a: number, b: number, c: number, d: number) => [number, number, number];
  readonly caml_pasta_fp_plonk_verifier_index_serialize: (a: number) => [number, number];
  readonly caml_pasta_fp_plonk_verifier_index_shifts: (a: number) => number;
  readonly caml_pasta_fp_plonk_verifier_index_write: (a: number, b: number, c: number, d: number) => [number, number];
  readonly caml_pasta_fq_plonk_circuit_serialize: (a: number, b: number) => [number, number];
  readonly caml_pasta_fq_plonk_gate_vector_add: (a: number, b: number) => void;
  readonly caml_pasta_fq_plonk_gate_vector_digest: (a: number, b: number) => [number, number];
  ...
  readonly caml_pasta_fq_plonk_verifier_index_deserialize: (a: number, b: number, c: number) => [number, number, number];
  readonly caml_pasta_fq_plonk_verifier_index_dummy: () => number;
  readonly caml_pasta_fq_plonk_verifier_index_read: (a: number, b: number, c: number, d: number) => [number, number, number];
  readonly caml_pasta_fq_plonk_verifier_index_serialize: (a: number) => [number, number];
  readonly caml_pasta_fq_plonk_verifier_index_shifts: (a: number) => number;
  readonly caml_pasta_fq_plonk_verifier_index_write: (a: number, b: number, c: number, d: number) => [number, number];
  readonly console_log: (a: number, b: number) => void;
  readonly create_zero_u32_ptr: () => number;
  readonly fq_oracles_create: (a: number, b: number, c: number, d: number) => [number, number, number];
  ...
  readonly prover_to_json: (a: number) => [number, number];
  ...
  readonly wasmfplookupcommitments_sorted: (a: number) => [number, number];
  ...
  readonly wasmfplookupverifierindex_lookup_table: (a: number) => [number, number];
  ...
  readonly wasmfpopeningproof_lr_0: (a: number) => [number, number];
  readonly wasmfpopeningproof_lr_1: (a: number) => [number, number];
  ...
  readonly wasmfpplonkverificationevals_coefficients_comm: (a: number) => [number, number];
  ...
  readonly wasmfpplonkverificationevals_sigma_comm: (a: number) => [number, number];
  ...
  readonly wasmfppolycomm_unshifted: (a: number) => [number, number];
  ...
  readonly wasmfpprovercommitments_w_comm: (a: number) => [number, number];
  ...
  readonly wasmfpproverproof_evals: (a: number) => any;
  readonly wasmfpproverproof_new: (a: number, b: number, c: any, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
  readonly wasmfpproverproof_prev_challenges_comms: (a: number) => [number, number];
  readonly wasmfpproverproof_prev_challenges_scalars: (a: number) => number;
  readonly wasmfpproverproof_proof: (a: number) => number;
  readonly wasmfpproverproof_public_: (a: number) => [number, number];
  readonly wasmfpproverproof_serialize: (a: number) => [number, number];
  readonly wasmfpproverproof_set_commitments: (a: number, b: number) => void;
  readonly wasmfpproverproof_set_evals: (a: number, b: any) => void;
  ...
  readonly wasmfqlookupverifierindex_lookup_table: (a: number) => [number, number];
  ...
  readonly wasmfqoracles_opening_prechallenges: (a: number) => [number, number];
  readonly wasmfqoracles_set_opening_prechallenges: (a: number, b: number, c: number) => void;
  readonly wasmfqplonkverificationevals_coefficients_comm: (a: number) => [number, number];
  ...
  readonly wasmfqplonkverificationevals_sigma_comm: (a: number) => [number, number];
  ...
  readonly wasmfqpolycomm_unshifted: (a: number) => [number, number];
  ...
  readonly __wbg_get_wasmfpopeningproof_z1: (a: number) => [number, number];
  readonly __wbg_get_wasmfpshifts_s0: (a: number) => [number, number];
  readonly __wbg_get_wasmfpshifts_s1: (a: number) => [number, number];
  readonly __wbg_get_wasmfqshifts_s0: (a: number) => [number, number];
  ...
  readonly caml_fq_srs_read: (a: number, b: number, c: number) => [number, number, number];
  ...
  readonly __wbg_get_wasmgpallas_x: (a: number) => [number, number];
  readonly __wbg_get_wasmgpallas_y: (a: number) => [number, number];
  readonly __wbg_get_wasmgvesta_x: (a: number) => [number, number];
  readonly __wbg_get_wasmgvesta_y: (a: number) => [number, number];
  ...
  readonly wasmgpallas_wasm_clone: (a: number) => number;
  readonly wasmgvesta_wasm_clone: (a: number) => number;
  ...
  readonly caml_bigint_256_deep_copy: (a: number, b: number) => [number, number];
  readonly caml_bigint_256_div: (a: number, b: number, c: number, d: number) => [number, number];
  readonly caml_bigint_256_num_limbs: () => number;
  readonly caml_bigint_256_of_bytes: (a: number, b: number) => [number, number];
  readonly caml_bigint_256_of_decimal_string: (a: number, b: number) => [number, number];
  readonly caml_bigint_256_of_numeral: (a: number, b: number, c: number, d: number) => [number, number];
  readonly caml_bigint_256_test_bit: (a: number, b: number, c: number) => number;
  readonly caml_bigint_256_to_bytes: (a: number, b: number) => [number, number];
