/* tslint:disable */
/* eslint-disable */
export const __wbg_wasmvecfp_free: (a: number, b: number) => void;
...
export const caml_vesta_endo_base: () => [number, number];
export const caml_vesta_endo_scalar: () => [number, number];
...
export const wasmvecfp_create: (a: number) => number;
export const wasmvecfp_get: (a: number, b: number) => [number, number];
export const wasmvecfp_push: (a: number, b: number, c: number) => void;
export const wasmvecfp_set: (a: number, b: number, c: number, d: number) => void;
export const wasmvecvecfp_create: (a: number) => number;
export const wasmvecvecfp_get: (a: number, b: number) => [number, number];
...
export const caml_pallas_endo_base: () => [number, number];
export const caml_pallas_endo_scalar: () => [number, number];
...
export const __wbg_get_wasmfqoracles_digest_before_evaluations: (a: number) => [number, number];
export const __wbg_get_wasmfqoracles_o: (a: number) => number;
export const __wbg_get_wasmfqoracles_p_eval0: (a: number) => [number, number];
export const __wbg_get_wasmfqoracles_p_eval1: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_alpha: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_alpha_chal: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_beta: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_gamma: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_joint_combiner: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_joint_combiner_chal: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_u: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_u_chal: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_v: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_v_chal: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_zeta: (a: number) => [number, number];
export const __wbg_get_wasmfqrandomoracles_zeta_chal: (a: number) => [number, number];
...
export const fq_oracles_create: (a: number, b: number, c: number, d: number) => [number, number, number];
...
export const wasmfqoracles_opening_prechallenges: (a: number) => [number, number];
...
export const __wbg_wasmvecfq_free: (a: number, b: number) => void;
export const __wbg_wasmvecvecfq_free: (a: number, b: number) => void;
export const wasmvecfq_create: (a: number) => number;
export const wasmvecfq_get: (a: number, b: number) => [number, number];
export const wasmvecfq_push: (a: number, b: number, c: number) => void;
export const wasmvecfq_set: (a: number, b: number, c: number, d: number) => void;
export const wasmvecvecfq_create: (a: number) => number;
export const wasmvecvecfq_get: (a: number, b: number) => [number, number];
...
export const __wbg_get_wasmfqopeningproof_z1: (a: number) => [number, number];
export const __wbg_get_wasmfqopeningproof_z2: (a: number) => [number, number];
export const __wbg_get_wasmfqproverproof_ft_eval1: (a: number) => [number, number];
...
export const caml_pasta_fp_poseidon_block_cipher: (a: number, b: number) => [number, number];
export const caml_pasta_fq_plonk_index_create: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
export const caml_pasta_fq_plonk_index_decode: (a: number, b: number, c: number) => [number, number, number];
...
export const caml_pasta_fq_plonk_index_encode: (a: number) => [number, number, number, number];
...
export const caml_pasta_fq_plonk_index_read: (a: number, b: number, c: number, d: number) => [number, number, number];
export const caml_pasta_fq_plonk_index_serialize: (a: number) => [number, number];
export const caml_pasta_fq_plonk_index_write: (a: number, b: number, c: number, d: number) => [number, number];
export const caml_pasta_fq_plonk_proof_batch_verify: (a: number, b: number, c: number, d: number) => number;
export const caml_pasta_fq_plonk_proof_create: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
...
export const caml_pasta_fq_poseidon_block_cipher: (a: number, b: number) => [number, number];
export const initThreadPool: (a: number, b: any) => any;
...
export const wasmfqlookupcommitments_sorted: (a: number) => [number, number];
export const wasmfqopeningproof_delta: (a: number) => number;
export const wasmfqopeningproof_lr_0: (a: number) => [number, number];
export const wasmfqopeningproof_lr_1: (a: number) => [number, number];
...
export const wasmfqprovercommitments_w_comm: (a: number) => [number, number];
export const wasmfqprovercommitments_z_comm: (a: number) => number;
export const wasmfqproverproof_commitments: (a: number) => number;
export const wasmfqproverproof_deserialize: (a: number, b: number) => number;
export const wasmfqproverproof_evals: (a: number) => any;
export const wasmfqproverproof_new: (a: number, b: number, c: any, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
export const wasmfqproverproof_prev_challenges_comms: (a: number) => [number, number];
...
export const wasmfqproverproof_public_: (a: number) => [number, number];
export const wasmfqproverproof_serialize: (a: number) => [number, number];
export const wasmfqproverproof_set_commitments: (a: number, b: number) => void;
export const wasmfqproverproof_set_evals: (a: number, b: any) => void;
...
export const __wbg_get_wasmfpdomain_group_gen: (a: number) => [number, number];
...
export const __wbg_get_wasmfpopeningproof_z2: (a: number) => [number, number];
export const __wbg_get_wasmfporacles_digest_before_evaluations: (a: number) => [number, number];
export const __wbg_get_wasmfporacles_o: (a: number) => number;
export const __wbg_get_wasmfporacles_p_eval0: (a: number) => [number, number];
export const __wbg_get_wasmfporacles_p_eval1: (a: number) => [number, number];
...
export const __wbg_get_wasmfpproverproof_ft_eval1: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_alpha: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_alpha_chal: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_beta: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_gamma: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_joint_combiner: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_joint_combiner_chal: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_u: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_u_chal: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_v: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_v_chal: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_zeta: (a: number) => [number, number];
export const __wbg_get_wasmfprandomoracles_zeta_chal: (a: number) => [number, number];
export const __wbg_get_wasmfpshifts_s2: (a: number) => [number, number];
export const __wbg_get_wasmfpshifts_s3: (a: number) => [number, number];
export const __wbg_get_wasmfpshifts_s4: (a: number) => [number, number];
export const __wbg_get_wasmfpshifts_s5: (a: number) => [number, number];
export const __wbg_get_wasmfpshifts_s6: (a: number) => [number, number];
export const __wbg_get_wasmfqdomain_group_gen: (a: number) => [number, number];
export const __wbg_get_wasmfqpolycomm_shifted: (a: number) => number;
export const __wbg_get_wasmfqshifts_s1: (a: number) => [number, number];
export const __wbg_get_wasmfqshifts_s2: (a: number) => [number, number];
export const __wbg_get_wasmfqshifts_s3: (a: number) => [number, number];
export const __wbg_get_wasmfqshifts_s4: (a: number) => [number, number];
export const __wbg_get_wasmfqshifts_s5: (a: number) => [number, number];
export const __wbg_get_wasmfqshifts_s6: (a: number) => [number, number];
...
export const caml_fp_srs_b_poly_commitment: (a: number, b: number, c: number) => [number, number, number];
export const caml_fp_srs_batch_accumulator_check: (a: number, b: number, c: number, d: number, e: number) => number;
export const caml_fp_srs_batch_accumulator_generate: (a: number, b: number, c: number, d: number) => [number, number];
export const caml_fp_srs_commit_evaluations: (a: number, b: number, c: number, d: number) => [number, number, number];
export const caml_fp_srs_create: (a: number) => number;
export const caml_fp_srs_create_parallel: (a: number) => number;
export const caml_fp_srs_get: (a: number) => [number, number];
export const caml_fp_srs_get_lagrange_basis: (a: number, b: number) => [number, number];
export const caml_fp_srs_h: (a: number) => number;
export const caml_fp_srs_lagrange_commitment: (a: number, b: number, c: number) => [number, number, number];
export const caml_fp_srs_lagrange_commitments_whole_domain_ptr: (a: number, b: number) => number;
export const caml_fp_srs_lagrange_commitments_whole_domain_read_from_ptr: (a: number) => [number, number];
export const caml_fp_srs_maybe_lagrange_commitment: (a: number, b: number, c: number) => number;
export const caml_fp_srs_read: (a: number, b: number, c: number) => [number, number, number];
...
export const caml_fp_srs_write: (a: number, b: number, c: number, d: number) => [number, number];
export const caml_fq_srs_add_lagrange_basis: (a: number, b: number) => void;
export const caml_fq_srs_b_poly_commitment: (a: number, b: number, c: number) => [number, number, number];
export const caml_fq_srs_batch_accumulator_check: (a: number, b: number, c: number, d: number, e: number) => number;
export const caml_fq_srs_batch_accumulator_generate: (a: number, b: number, c: number, d: number) => [number, number];
export const caml_fq_srs_commit_evaluations: (a: number, b: number, c: number, d: number) => [number, number, number];
export const caml_fq_srs_create: (a: number) => number;
export const caml_fq_srs_create_parallel: (a: number) => number;
export const caml_fq_srs_get: (a: number) => [number, number];
export const caml_fq_srs_get_lagrange_basis: (a: number, b: number) => [number, number];
export const caml_fq_srs_h: (a: number) => number;
export const caml_fq_srs_lagrange_commitment: (a: number, b: number, c: number) => [number, number, number];
export const caml_fq_srs_lagrange_commitments_whole_domain_ptr: (a: number, b: number) => number;
export const caml_fq_srs_lagrange_commitments_whole_domain_read_from_ptr: (a: number) => [number, number];
...
export const caml_fq_srs_write: (a: number, b: number, c: number, d: number) => [number, number];
export const caml_pasta_fp_plonk_circuit_serialize: (a: number, b: number) => [number, number];
...
export const caml_pasta_fp_plonk_gate_vector_digest: (a: number, b: number) => [number, number];
...
export const caml_pasta_fp_plonk_index_create: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
export const caml_pasta_fp_plonk_index_decode: (a: number, b: number, c: number) => [number, number, number];
...
export const caml_pasta_fp_plonk_index_encode: (a: number) => [number, number, number, number];
...
export const caml_pasta_fp_plonk_index_read: (a: number, b: number, c: number, d: number) => [number, number, number];
export const caml_pasta_fp_plonk_index_serialize: (a: number) => [number, number];
export const caml_pasta_fp_plonk_index_write: (a: number, b: number, c: number, d: number) => [number, number];
export const caml_pasta_fp_plonk_proof_batch_verify: (a: number, b: number, c: number, d: number) => number;
export const caml_pasta_fp_plonk_proof_create: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
...
export const caml_pasta_fp_plonk_verifier_index_deserialize: (a: number, b: number, c: number) => [number, number, number];
export const caml_pasta_fp_plonk_verifier_index_dummy: () => number;
export const caml_pasta_fp_plonk_verifier_index_read: (a: number, b: number, c: number, d: number) => [number, number, number];
export const caml_pasta_fp_plonk_verifier_index_serialize: (a: number) => [number, number];
export const caml_pasta_fp_plonk_verifier_index_shifts: (a: number) => number;
export const caml_pasta_fp_plonk_verifier_index_write: (a: number, b: number, c: number, d: number) => [number, number];
export const caml_pasta_fq_plonk_circuit_serialize: (a: number, b: number) => [number, number];
export const caml_pasta_fq_plonk_gate_vector_add: (a: number, b: number) => void;
export const caml_pasta_fq_plonk_gate_vector_digest: (a: number, b: number) => [number, number];
...
export const caml_pasta_fq_plonk_verifier_index_deserialize: (a: number, b: number, c: number) => [number, number, number];
export const caml_pasta_fq_plonk_verifier_index_dummy: () => number;
export const caml_pasta_fq_plonk_verifier_index_read: (a: number, b: number, c: number, d: number) => [number, number, number];
export const caml_pasta_fq_plonk_verifier_index_serialize: (a: number) => [number, number];
export const caml_pasta_fq_plonk_verifier_index_shifts: (a: number) => number;
export const caml_pasta_fq_plonk_verifier_index_write: (a: number, b: number, c: number, d: number) => [number, number];
export const console_log: (a: number, b: number) => void;
export const create_zero_u32_ptr: () => number;
export const fp_oracles_create: (a: number, b: number, c: number, d: number) => [number, number, number];
export const fp_oracles_dummy: () => number;
export const free_u32_ptr: (a: number) => void;
export const get_memory_byte_length: () => number;
export const prover_to_json: (a: number) => [number, number];
...
export const wasmfplookupcommitments_sorted: (a: number) => [number, number];
...
export const wasmfplookupverifierindex_lookup_table: (a: number) => [number, number];
...
export const wasmfpopeningproof_lr_0: (a: number) => [number, number];
export const wasmfpopeningproof_lr_1: (a: number) => [number, number];
...
export const wasmfporacles_opening_prechallenges: (a: number) => [number, number];
export const wasmfporacles_set_opening_prechallenges: (a: number, b: number, c: number) => void;
export const wasmfpplonkverificationevals_coefficients_comm: (a: number) => [number, number];
...
export const wasmfpplonkverificationevals_sigma_comm: (a: number) => [number, number];
...
export const wasmfppolycomm_unshifted: (a: number) => [number, number];
...
export const wasmfpprovercommitments_w_comm: (a: number) => [number, number];
export const wasmfpprovercommitments_z_comm: (a: number) => number;
export const wasmfpproverproof_commitments: (a: number) => number;
export const wasmfpproverproof_deserialize: (a: number, b: number) => number;
export const wasmfpproverproof_evals: (a: number) => any;
export const wasmfpproverproof_new: (a: number, b: number, c: any, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
export const wasmfpproverproof_prev_challenges_comms: (a: number) => [number, number];
...
export const wasmfpproverproof_public_: (a: number) => [number, number];
export const wasmfpproverproof_serialize: (a: number) => [number, number];
export const wasmfpproverproof_set_commitments: (a: number, b: number) => void;
export const wasmfpproverproof_set_evals: (a: number, b: any) => void;
...
export const wasmfqlookupverifierindex_lookup_table: (a: number) => [number, number];
...
export const wasmfqplonkverificationevals_coefficients_comm: (a: number) => [number, number];
...
export const wasmfqplonkverificationevals_sigma_comm: (a: number) => [number, number];
...
export const wasmfqpolycomm_unshifted: (a: number) => [number, number];
...
export const __wbg_get_wasmfpopeningproof_z1: (a: number) => [number, number];
export const __wbg_get_wasmfpshifts_s0: (a: number) => [number, number];
export const __wbg_get_wasmfpshifts_s1: (a: number) => [number, number];
export const __wbg_get_wasmfqshifts_s0: (a: number) => [number, number];
...
export const caml_fq_srs_read: (a: number, b: number, c: number) => [number, number, number];
...
export const __wbg_get_wasmgpallas_x: (a: number) => [number, number];
export const __wbg_get_wasmgpallas_y: (a: number) => [number, number];
export const __wbg_get_wasmgvesta_x: (a: number) => [number, number];
export const __wbg_get_wasmgvesta_y: (a: number) => [number, number];
...
export const wasmgpallas_wasm_clone: (a: number) => number;
export const wasmgvesta_wasm_clone: (a: number) => number;
...
export const caml_bigint_256_deep_copy: (a: number, b: number) => [number, number];
export const caml_bigint_256_div: (a: number, b: number, c: number, d: number) => [number, number];
export const caml_bigint_256_num_limbs: () => number;
export const caml_bigint_256_of_bytes: (a: number, b: number) => [number, number];
export const caml_bigint_256_of_decimal_string: (a: number, b: number) => [number, number];
export const caml_bigint_256_of_numeral: (a: number, b: number, c: number, d: number) => [number, number];
export const caml_bigint_256_test_bit: (a: number, b: number, c: number) => number;
export const caml_bigint_256_to_bytes: (a: number, b: number) => [number, number];
